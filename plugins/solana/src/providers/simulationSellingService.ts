...
export class SimulationSellingService {
    ...
    constructor(runtime:  any, trustScoreDb: TrustScoreDatabase) {
    ...
    public async startService() {
        ...
        Logger.log("Starting SellingService...");
        await this.startListeners();
    }

    public async startListeners() {
        // scanning recommendations and selling
        Logger.log("Scanning for token performances...");
    ...
    private async startProcessInTheSonarBackend(
        ...
        try {
            ...
            Logger.log("Received response:", result);
            Logger.log(`Sent message to process token ${tokenAddress}`);
