...
export class GetAvailableLicensesAction {
    ...
    async getAvailableLicenses(
        ...
        try {
            ...
            Logger.log("licenseDetailsResponse", licenseDetailsResponse);
...
export const getAvailableLicensesAction = {
    ...
    handler: async (
        ...
        Logger.log("Starting GET_AVAILABLE_LICENSES handler...");
        ...
        try {
            ...
            Logger.error("Error fetching available licenses:", e.message);
            callback?.({
