...
export async function listResource(
    ...
    try {
        ...
        Logger.log(`Calling Story API ${resourceName}`);
        Logger.log(`STORY_API_KEY: ${API_KEY}`);
        Logger.log(`API_URL: ${API_URL}`);
        Logger.log(`API_VERSION: ${API_VERSION}`);
        Logger.log(`_options: ${JSON.stringify(_options)}`);
        ...
        Logger.log("List resource Error");
        console.error(error);
    }
}
