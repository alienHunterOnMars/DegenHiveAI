...
export function getEmbeddingType(runtime: any): "local" | "remote" {
    const isNode =
 ...
 * @param {any} runtime - The agent runtime context
 * @returns {Promise<number[]>} Array of embedding values
 * @throws {Error} If the API request fails
 */

export async function embed(runtime: any, input: string) {
