...
from hivemind.utils.serialize import (  actionoutout_schema_to_mapping,  actionoutput_mapping_to_str, actionoutput_str_to_mapping)
from hivemind.const import MESSAGE_ROUTE_FROM, MESSAGE_ROUTE_TO, MESSAGE_ROUTE_CAUSE_BY, MESSAGE_META_ROLE, MESSAGE_ROUTE_TO_ALL, MESSAGE_ROUTE_TO_NONE
from hivemind.utils.common import any_to_str, any_to_str_set, import_class
from hivemind.logs import logger
from hivemind.utils.exceptions import handle_exception
...
class Message(BaseModel):
    ...
    def check_instruct_content(cls, ic: Any) -> BaseModel:
        if ic and isinstance(ic, dict) and "class" in ic:
            if "mapping" in ic:
                ...
                actionnode_class = import_class("ActionNode", "hivemind.actions.action_node")  # avoid circular import
    ...
    def check_cause_by(cls, cause_by: Any) -> str:
        return any_to_str(cause_by if cause_by else import_class("UserRequirement", "hivemind.actions.add_requirement"))
    ...
    def ser_instruct_content(self, ic: BaseModel) -> Union[dict, None]:
        ...
        if ic:
            ...
            ic_type = str(type(ic))
            if "<class 'hivemind.actions.action_node" in ic_type:
