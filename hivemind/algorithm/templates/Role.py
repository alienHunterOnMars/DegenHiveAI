...
from hivemind.schema import Message, MessageQueue, SerializationMixin
from hivemind.utils.common import any_to_name, any_to_str, role_raise_decorator
from hivemind.logs import logger

from hivemind.actions import Action, ActionOutput
...
class RoleContext(BaseModel):
    ...
    msg_buffer: MessageQueue = Field( default_factory=MessageQueue, exclude=True)  # Message Buffer with Asynchronous Updates
    ...
    def model_rebuild(cls, **kwargs):
        from hivemind.environment.base_env import Environment  # noqa: F401
